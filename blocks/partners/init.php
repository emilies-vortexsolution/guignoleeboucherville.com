  ...
  add_action(
    ...
    function() {
      ...
      acf_register_block_type(
        array(
          'name'            => $block_slug,
          'title'           => _x( 'Partners', 'Block name', 'vtx' ),
          'description'     => _x( 'Display partners in a grid.', 'Block description', 'vtx' ),
          ...
          'icon'            => 'businessman', // WordPress’ Dashicons or Custom (see documentation)
          'supports'        => array(
