  ...
  add_action(
    ...
    function() {
      ...
      acf_register_block_type(
        array(
          'name'            => $block_slug,
          'title'           => _x( 'Informational Columns', 'Block name', 'vtx' ),
          'description'     => _x( 'A two-columns section to display information.', 'Block description', 'vtx' ),
          ...
          'icon'            => 'editor-table', // WordPress’ Dashicons or Custom (see documentation)
          'supports'        => array(
